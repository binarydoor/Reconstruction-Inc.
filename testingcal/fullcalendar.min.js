...
$(document).ready(function() {
  ...
  firebase.initializeApp(config);
    var eventdb = [{title:'333', start: '2018-12-11'},{title: '222', start:'2018-12-23'}];
    var asmt = [];
    var duedate = [];
...
//get("dateProfile"));e.isValid&&(this.currentDate=e.date,this.renderView())},t.
